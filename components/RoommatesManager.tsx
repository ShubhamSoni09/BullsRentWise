      ...
      <div className="app-card p-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <div>
            ...
            <h2 className="text-base font-black text-slate-950">My Roommates</h2>
          </div>
        </div>
      ...
      <div className="space-y-3">
        ...
        <div className="rounded-2xl border border-blue-100 bg-blue-50 p-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              onClick={handleShare}
              className="rounded-xl bg-blue-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-blue-700"
            >
              Share
            </button>
          </div>
          <div className="flex items-center gap-2">
            <code className="flex-1 rounded-xl border border-blue-200 bg-white px-3 py-2.5 text-sm font-semibold text-slate-950">
              {shareCode}
            </code>
            <button
              onClick={() => {
        ...
        {roommates.length > 0 ? (
          <div className="space-y-2 max-h-48 overflow-y-auto scroll-smooth" style={{ scrollBehavior: 'smooth' }}>
            ...
            {roommates.map((roommate) => (
              <div
                key={roommate.id}
                className="flex items-center justify-between rounded-2xl border border-slate-100 bg-slate-50 p-3 transition hover:bg-white hover:shadow-sm"
              >
            ...
            {avgBudget > 0 && (
              <div className="mt-3 rounded-2xl border border-teal-100 bg-teal-50 p-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold text-teal-700">${avgBudget.toFixed(0)}/person</span>
                </div>
                <div className="flex justify-between text-sm mt-1">
                  <span className="text-gray-700 font-medium">Total Budget:</span>
                  <span className="font-bold text-teal-700">${totalBudget.toFixed(0)}/mo</span>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="empty-state animate-fadeIn">
            <div className="mb-2 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-100">
