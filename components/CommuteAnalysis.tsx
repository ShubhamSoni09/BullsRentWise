  ...
  return (
    <div className="app-card p-4">
      <div className="flex items-center gap-2 mb-4">
        <div className="icon-tile h-9 w-9 bg-cyan-600">
          <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
          </svg>
        </div>
        <h3 className="text-base font-black text-slate-950">Commute & Transportation</h3>
      </div>
      ...
      <div className="space-y-4">
        <div className="rounded-2xl border border-blue-100 bg-blue-50 p-3">
          <h4 className="font-semibold text-gray-900 text-sm mb-3 flex items-center gap-2">
            ...
            {data.locationContext.label}
          </h4>
          <p className="text-xs leading-5 text-slate-600">{data.locationContext.note}</p>
          <div className="mt-3 rounded-2xl border border-blue-100 bg-white p-3">
            <div className="text-xs text-gray-600 mb-1">Estimated nearest transit</div>
            <div className="font-bold text-blue-700">{data.distanceToTransit} mi</div>
          </div>
        </div>
        ...
        {data.transitRoutes.length > 0 && (
          <div className="rounded-2xl border border-orange-100 bg-orange-50 p-3">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs font-semibold text-orange-700 bg-orange-100 px-2 py-1 rounded-lg">local routes</span>
            </div>
            <div className="space-y-2">
              {data.transitRoutes.map((route, idx) => (
                <div key={idx} className="rounded-2xl border border-orange-100 bg-white p-3">
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center justify-between text-xs pt-1 border-t border-orange-100">
                      <span className="text-gray-600 font-medium">Use:</span>
